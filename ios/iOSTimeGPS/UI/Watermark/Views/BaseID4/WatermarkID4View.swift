...
class WatermarkID4View: BaseWatermark {
...
//        watermarkThemeColor = UIColor.fromHex("#FFC233")
        ...
        bottomTableView.configDatas(items: watermarkModel?.allBottomOpenItem ?? [], maxWidth: GPApp.screenWidth - 100, templateColor: watermarkTextColor)
    ...
    override func layoutSubviews() {
        ...
        topTableView.frame = CGRect(x: 12, y: viewTotalH - 6, width: topTableWidth, height: topTableHeight)
        if topTableHeight > 0 {
