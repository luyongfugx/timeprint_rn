...
import javax.microedition.khronos.egl.EGLContext
 ...
 open class GpGlSurfaceView :SurfaceView, SurfaceHolder.Callback {
   ...
   private val TAG = this.javaClass.simpleName
    ...
    override fun surfaceChanged(holder: SurfaceHolder, format: Int, width: Int, height: Int) {
        Log.d(TAG,"GpGlSurfaceView surfaceChanged $width $height")
    ...
    class EglThread(private val surfaceViewReference: WeakReference<GpGlSurfaceView>) : Thread() {
