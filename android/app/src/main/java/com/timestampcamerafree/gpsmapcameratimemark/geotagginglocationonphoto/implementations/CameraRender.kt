...
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.egl.FboRender
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.egl.GpGlSurfaceView
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.utils.DisplayUtil
 ...
 * 从摄像头渲染到fbo。使用扩展纹理。
 */
class CameraRender(private val mContext: Context) : GpGlSurfaceView.CustomRender,
    ...
    private var flipMatrixLocation: Int = 0
    /**
     * 屏幕宽高
     */
    ...
    init {
       // idth=4608, height=2592 1080 ratio:1.7777778 height1920
        screenWidth = 1080
        screenHeight = 1920
    ...
    override fun onSurfaceCreated() {
        ...
        fboRender?.onCreate()
        Log.e(TAG, "CameraRender onSurfaceCreated")
        //获取顶点和片段着色器程序代码
        ...
        flipMatrixLocation = glGetUniformLocation(program, "u_FlipMatrix")
    ...
    override fun onSurfaceChanged(width: Int, height: Int) {
        ...
        screenWidth = width
        screenHeight = height
        Log.d(TAG,"CameraRender onSurfaceChanged ${width} ${height}")
    ...
    override fun onDrawFrame() {
        try {
            ...
            if (surfaceTexture != null && cameraTextureId != 0) {
                surfaceTexture?.updateTexImage()
            } else {
                Log.e(TAG, "SurfaceTexture or texture not ready")
                return
            }
        }catch (e:Exception){
            Log.e(TAG, "onDrawFrame updateTexImage ${e.message}")
        }
        ...
        if (flipHorizontal) {
            flipMatrix[0] = -1.0f  // 水平翻转
        }
        glUniformMatrix4fv(flipMatrixLocation, 1, false, flipMatrix, 0)
    ...
    override fun onFrameAvailable(p0: SurfaceTexture?) {
       // Log.d(TAG,"CameraRender onFrameAvailable ${width} ${height}")
    }
    ...
    fun release() {
        try {
            ...
            cameraTextureId = 0
            // 释放其他OpenGL资源...
            glDeleteTextures(1, intArrayOf(fboTextureid), 0)
