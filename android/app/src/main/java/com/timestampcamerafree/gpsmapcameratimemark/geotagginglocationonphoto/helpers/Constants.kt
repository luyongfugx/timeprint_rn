...
const val SHOW_OFFICIAL_WATERMARK = "show_official_watermark"
...
const val SAVE_ORIGIN_PHOTO = "save_origin_photo"
...
//更多设置
const val SETTING_MORE = 5

//设置存储目录
const val SETTING_SAVE_FOLDER = 6

//是否有快门声
const val SETTING_PLAY_SHUTTER_SOUND = 5

//当前用户选择的水印id
const val SELECT_WATERMARK_ID = "select_watermark_id"
const val SELECT_WATERMARK_JSON_PREFIX = "select_watermark_json_"
...
const val BROADCAST_REFRESH_MEDIA = "com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.REFRESH_MEDIA"
