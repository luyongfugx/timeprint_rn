...
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.R.color
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.ACCENT_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.APP_ICON_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.APP_ID
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.APP_PASSWORD_HASH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.APP_PASSWORD_PROTECTION
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.APP_PROTECTION_TYPE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.APP_RUN_COUNT
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.APP_SIDELOADING_STATUS
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.AUTO_BACKUP
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.AUTO_BACKUP_FILENAME
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.AUTO_BACKUP_FOLDER
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.BACKGROUND_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.BLOCK_HIDDEN_NUMBERS
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.BLOCK_UNKNOWN_NUMBERS
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.CONFLICT_SKIP
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.CUSTOM_ACCENT_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.CUSTOM_APP_ICON_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.CUSTOM_BACKGROUND_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.CUSTOM_PRIMARY_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.CUSTOM_TEXT_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DATE_FORMAT
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DATE_FORMAT_EIGHT
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DATE_FORMAT_FIVE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DATE_FORMAT_FOUR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DATE_FORMAT_ONE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DATE_FORMAT_SEVEN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DATE_FORMAT_SIX
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DATE_FORMAT_THREE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DATE_FORMAT_TWO
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DEFAULT_TAB
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DELETE_PASSWORD_HASH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DELETE_PASSWORD_PROTECTION
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.DELETE_PROTECTION_TYPE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.ENABLE_PULL_TO_REFRESH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.FAVORITES
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.FAVORITES_CONTACTS_ORDER
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.FAVORITES_CUSTOM_ORDER_SELECTED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.HAD_THANK_YOU_INSTALLED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.IGNORED_CONTACT_SOURCES
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.INITIAL_WIDGET_HEIGHT
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.INTERNAL_STORAGE_PATH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.IS_USING_AUTO_THEME
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.IS_USING_MODIFIED_APP_ICON
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.IS_USING_SHARED_THEME
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.IS_USING_SYSTEM_THEME
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.KEEP_LAST_MODIFIED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_AUTO_BACKUP_TIME
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_BLOCKED_NUMBERS_EXPORT_PATH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_CONFLICT_APPLY_TO_ALL
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_CONFLICT_RESOLUTION
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_COPY_PATH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_EXPORTED_SETTINGS_FOLDER
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_EXPORT_PATH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_HANDLED_SHORTCUT_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_ICON_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_RENAME_PATTERN_USED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_RENAME_USED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_USED_CONTACT_SOURCE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.LAST_VERSION
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.MERGE_DUPLICATE_CONTACTS
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.ON_CLICK_VIEW_CONTACT
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.ON_CONTACT_CLICK
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.OTG_ANDROID_DATA_TREE_URI
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.OTG_ANDROID_OBB_TREE_URI
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.OTG_PARTITION
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.OTG_REAL_PATH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.OTG_TREE_URI
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PASSWORD_HASH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PASSWORD_PROTECTION
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PREVENT_PHONE_FROM_SLEEPING
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PRIMARY_ANDROID_DATA_TREE_URI
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PRIMARY_ANDROID_OBB_TREE_URI
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PRIMARY_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PROTECTED_FOLDER_HASH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PROTECTED_FOLDER_TYPE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PROTECTION_NONE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PROTECTION_PATTERN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.PROTECTION_TYPE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.RENAME_SIMPLE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SCROLL_HORIZONTALLY
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SD_ANDROID_DATA_TREE_URI
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SD_ANDROID_OBB_TREE_URI
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SD_CARD_PATH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SD_TREE_URI
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOULD_USE_SHARED_THEME
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_ADDRESSES_FIELD
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_CALL_CONFIRMATION
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_CONTACT_FIELDS
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_CONTACT_SOURCE_FIELD
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_CONTACT_THUMBNAILS
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_DIALPAD_BUTTON
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_EMAILS_FIELD
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_EVENTS_FIELD
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_FIRST_NAME_FIELD
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_GROUPS_FIELD
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_INFO_BUBBLE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_NOTES_FIELD
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_ONLY_CONTACTS_WITH_NUMBERS
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_PHONE_NUMBERS
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_PHONE_NUMBERS_FIELD
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_PRIVATE_CONTACTS
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SHOW_SURNAME_FIELD
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SIDELOADING_UNCHECKED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SKIP_DELETE_CONFIRMATION
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SNOOZE_TIME
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SPEED_DIAL
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.START_NAME_WITH_SURNAME
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.SUNDAY_FIRST
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.TAB_LAST_USED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.TEXT_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.USE_24_HOUR_FORMAT
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.USE_ENGLISH
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.USE_SAME_SNOOZE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.VIEW_TYPE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.VIEW_TYPE_LIST
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_ALARM_WARNING_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_APP_ICON_CUSTOMIZATION_WARNING_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_APP_ON_SD_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_APP_RATED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_BEFORE_ASKING_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_BEFORE_RATE_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_CUSTOM_THEME_SWITCH_DESCRIPTION_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_FOLDER_LOCKING_NOTICE_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_INITIAL_UPGRADE_TO_PRO_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_LOCAL_ACCOUNT_INITIALIZED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_MESSENGER_RECORDER_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_ORANGE_ICON_CHECKED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_OTG_HANDLED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_RATE_US_PROMPT_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_REMINDER_WARNING_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_SHARED_THEME_EVER_ACTIVATED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_SHARED_THEME_FORCED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_SORTING_BY_NUMERIC_VALUE_ADDED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_UPGRADED_FROM_FREE_SHOWN
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WAS_USE_ENGLISH_TOGGLED
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WIDGET_BG_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WIDGET_ID_TO_MEASURE
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.WIDGET_TEXT_COLOR
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.YOUR_ALARM_SOUNDS
...
open class BaseConfig(val context: Context) {
    ...
    var textColor: Int
        get() = prefs.getInt(TEXT_COLOR, context.resources.getColor(color.default_text_color))
        set(textColor) = prefs.edit().putInt(TEXT_COLOR, textColor).apply()

    var backgroundColor: Int
        get() = prefs.getInt(BACKGROUND_COLOR, context.resources.getColor(color.default_background_color))
        set(backgroundColor) = prefs.edit().putInt(BACKGROUND_COLOR, backgroundColor).apply()

    var primaryColor: Int
        get() = prefs.getInt(PRIMARY_COLOR, context.resources.getColor(color.default_primary_color))
        set(primaryColor) = prefs.edit().putInt(PRIMARY_COLOR, primaryColor).apply()

    var accentColor: Int
        get() = prefs.getInt(ACCENT_COLOR, context.resources.getColor(color.default_accent_color))
    ...
    var appIconColor: Int
        get() = prefs.getInt(APP_ICON_COLOR, context.resources.getColor(color.default_app_icon_color))
        set(appIconColor) {
            isUsingModifiedAppIcon = appIconColor != context.resources.getColor(color.color_primary)
            prefs.edit().putInt(APP_ICON_COLOR, appIconColor).apply()
        }

    var lastIconColor: Int
        get() = prefs.getInt(LAST_ICON_COLOR, context.resources.getColor(color.color_primary))
    ...
    var widgetBgColor: Int
        get() = prefs.getInt(WIDGET_BG_COLOR, context.resources.getColor(color.default_widget_bg_color))
        set(widgetBgColor) = prefs.edit().putInt(WIDGET_BG_COLOR, widgetBgColor).apply()

    var widgetTextColor: Int
        get() = prefs.getInt(WIDGET_TEXT_COLOR, context.resources.getColor(color.default_widget_text_color))
    ...
    var isUsingSystemTheme: Boolean
        get() = prefs.getBoolean(
            ...
            com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.helpers.isSPlus()
        )
