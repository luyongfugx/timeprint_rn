...
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.degreesFromOrientation
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.getDocumentFile
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.getOutputMediaFilePath
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.getParentPath
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.getSomeDocumentFile
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.hasProperStoredTreeUri
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.getInternalStoragePath
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.isPathOnOTG
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.needsStupidWritePermissions
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.saveImageRotation
import com.timestampcamerafree.gpsmapcameratimemark.geotagginglocationonphoto.extensions.showErrorToast
    ...
    override fun doInBackground(vararg params: ByteArray): String {
        ...
        try {
            ...
            if (activity.config.savePhotoMetadata && !isThirdPartyIntent) {
                val exifInterface = if (path.startsWith(activity.getInternalStoragePath())) {
                    ExifInterface(path)
                } else {
